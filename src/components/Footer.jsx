            ...
            <div className="mx-auto max-w-screen-xl">
                    ...
                    <div className="flex flex-col mb-6 md:mb-0">
                        {/* <a href="https://flowbite.com" className="flex items-center">
                            <img
                                ...
                                alt="FlowBite Logo"
                            />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white poppins-extrabold">
                                SabaFab
          </span>
                        </a> */}
                        <span className="flex">
                        <MailOutlined style={{ fontSize: 26 }} className="py-2" />
                        <p className="font-bold p-3">customercare@sabafabrics.com</p>
                        </span>
                        <span className="flex">
                        <PhoneOutlined style={{ fontSize: 26 }} className="py-2" />
                    ...
                    <div className="grid grid-cols-3 gap-14 md:gap-1">
                        <div>
                            ...
                            <ul className="text-gray-900 dark:text-gray-400">
                                ...
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:text-gray-900 hover:font-medium">
                                        Unstitiched Fabric
              </a>
                                </li>
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a
                            href="#"
                            className="text-gray-500 hover:text-gray-900 hover:font-bold dark:hover:text-white"
                        >
                            <svg
                                className="w-5 h-5"
                                fill="currentColor"
