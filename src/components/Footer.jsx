      ...
      <footer className="p-4 mt-8 bg-emerald-100 dark:bg-gray-800">
        <div className="mx-auto max-w-screen-xl">
          <div className="flex justify-between">
            <div className="flex flex-col mb-6 md:mb-0">
              <span className="flex">
                ...
                <p className="text-sm font-semibold md:font-bold p-3">customercare@sabafabrics.com</p>
              </span>
              <span className="flex">
                <PhoneOutlined  className="text-xl md:text-3xl py-2" />
                <p className="text-sm font-semibold md:font-bold p-3">0340-2196848</p>
              </span>
            </div>
          ...
          >
            ...
            <div className="hidden md:hidden lg:grid grid-cols-3">
              <div>
